...
namespace BtkAkademi.Services.ShoppingCartAPI.Controllers
{
    [Route("api/cartc")]
    public class CartAPICheckOutController : ControllerBase
    {
        ...
        public Payment OdemeIslemi(CheckoutHeaderDto checkoutHeaderDto)
        {
            ...
            options.ApiKey = "sandbox-H4K3JGLVbcPtRQ68TkgT7fyKqE2Zu5iI";
            options.SecretKey = "sandbox-gI5YGcXYtzlvAiCQF3myUDkTxnv6XoMF";
